...
const userSchema = new mongoose.Schema({
    ...
    aadharNumber: { type: String, unique: true, sparse: true, select: false },
    aadharHash: { type: String, unique: true, sparse: true },
    aadharMasked: { type: String, default: '' },
    ...
    createdVia: { type: String, enum: ['self', 'admin', 'staff'], default: 'self' },
    createdByEmail: { type: String },
    accountStatus: { type: String, enum: ['active', 'deletion_requested', 'anonymized'], default: 'active' },
