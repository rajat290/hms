...
const validatorEntries = [
  {
    ...
    validator: objectField({
      ...
      date: numberField(),
      visitStatus: enumStringField(['requested', 'accepted', 'checked_in', 'in_consultation', 'completed', 'cancelled']),
      ...
      checkedInAt: dateField(),
      consultationStartedAt: dateField(),
      completedAt: dateField(),
      cancelledAt: dateField(),
      lastStatusUpdatedAt: dateField(),
      cancellationReason: stringField(),
      rescheduledCount: numberField(),
      lastRescheduledAt: dateField(),
    ...
    }, ['userId', 'docId', 'userData', 'docData', 'amount', 'slotTime', 'slotDate', 'date', 'visitStatus']),
  },
  {
  ...
  },
  {
    ...
    validator: objectField({
      ...
      resetOtpCodeHash: stringField(),
      resetOtpExpiry: dateField(),
      resetOtpAttempts: numberField(),
